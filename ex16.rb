...
target.write(line1) #telling the script to write each line given by user to the opened (now truncated) file.
target.write("\n")
target.write(line2)
target.write("\n")
target.write(line3)
...
#how come i can't reopen the new target file in this script and read it?
